#!/usr/bin/env python3
"""Minimal evaluator for MLV-Bench multiple-choice predictions.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate MLV-Bench MCQ predictions.")
    parser.add_argument("--benchmark", required=True, type=Path, help="Path to mlvbench.jsonl")
